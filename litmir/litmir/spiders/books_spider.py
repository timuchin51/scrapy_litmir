...
class BooksSpider(CrawlSpider):
    ...
    def parse_book(self, response):
        ...
        loader.add_xpath('book_name', '//div[@itemprop="name"]/text()')
        ...
        loader.add_value('book_id', urlparse(response.url).query)
        loader.add_xpath('author_from_book_id', '//td[@class="bd_desc2"]/div[1]/a/@href')
    ...
    def parse_author(self, response):
        ...
        loader.add_xpath('author_name', '//div[@itemprop="name"]/descendant::*/text()')
        ...
        loader.add_value('author_id', urlparse(response.url).query)
        yield loader.load_item()
